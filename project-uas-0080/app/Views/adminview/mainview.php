...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-header">DATA PERPUSTAKAAN STMIK</li>
            <li class="nav-item">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <a class="fw-bold" href="https://h3h3y.github.io/cv-iwan.github.io/" target="_blank">Iwan Sanusi.</a></strong>  All rights reserved
  </footer>
